...
const proof_documents = {
  aadhaar: {
    ...
    aadhaar_number:
      "Type: Number, A 12 digit number, May contain gaps but return as a single 12 digit number",
    phone_number:
      "Type: Number, A 10 digit number, May contain gaps but return as a single 10 digit number",
  },
  pan: {
    name: "Type: String, Name of the candidate",
    pan_number:
      "Type: mixed of Capital letter and number, May contain gaps but return as a single 10 digit number",
    phone_number:
      "Type: Number, A 10 digit number, May contain gaps but return as a single 10 digit number",
    date_of_birth: "Type: Date, Date of birth in DD-MM-YYYY format",
  },
